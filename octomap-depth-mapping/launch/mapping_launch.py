...
def generate_launch_description():
    return LaunchDescription([
        ...
        Node(
            ...
            executable='octomap_depth_mapping', # This should match the executable name in your CMakeLists.txt
            name='octodm_node',
            output='screen',
            remappings=[('image_in', '/front_cam/depth_converted'),
                        ('pose_in', '/mavros/local_position/pose'),
                        ('map_out', 'octomap_mapping')],
